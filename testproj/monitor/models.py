...
class DataSet(models.Model):
    ...
    def df_spark_count(self):
        ...
        conf = SparkConf().setAppName('TestProjApp1').setMaster("spark://localhost:7077").set('spark.pyspark.python', '/home/alex/big_data_edx/venvs/bin/python3').set('spark.pyspark.driver.python','/home/alex/big_data_edx/venvs/bin/python3')
