...
class Courses(models.Model):
    ...
    subsection = models.ManyToManyField('Subsections', verbose_name="Подразделы курса", blank=True,
                                    null=True)
    partner = models.ForeignKey('Platform',on_delete=models.CASCADE, verbose_name="Платформа", null=True)
...
class Pages(models.Model):
    ...
    name = models.CharField("Наименование",max_length=1024, blank=True, null=True)
    time = models.DurationField('Время просмотра страницы', max_length=1024, blank=True, null=True)
